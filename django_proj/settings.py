...
ALLOWED_HOSTS = ['codenificentbg.herokuapp.com/', 'codenificentbg-cli.herokuapp.com', '127.0.0.1']
...
AWS_ACCESS_KEY_ID = os.environ.get('AWS_S3_IDKEY')
AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_S3_ACCESS1')
